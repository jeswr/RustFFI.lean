// FIXME: See if we need to do this https://rust-lang.github.io/rust-bindgen/library-usage.html noting that we should
// be using the stage1 lean.h files#

// Note there is also https://crates.io/crates/lean4_sys but it seems to have been taken down for some reason
...
pub const LEAN_VERSION_MINOR: u32 = 6;
pub const LEAN_VERSION_PATCH: u32 = 0;
pub const LEAN_VERSION_IS_RELEASE: u32 = 0;
pub const LEAN_SPECIAL_VERSION_DESC: &[u8; 1] = b"\0";
pub const LEAN_PLATFORM_TARGET: &[u8; 1] = b"\0";
